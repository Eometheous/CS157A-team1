...
<%
    ...
    try {
        ...
        String sqlStatement = "SELECT flight_id, a1.airport_name AS `from`, a2.airport_name AS `to`, flight.departure_time, flight.arrival_time FROM flight, airport a1, airport a2 WHERE a1.airport_id = flight.departing_airport AND a2.airport_id = flight.arriving_airport;";
;
